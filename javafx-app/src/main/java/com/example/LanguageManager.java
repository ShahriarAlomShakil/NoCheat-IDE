...
public class LanguageManager {
    ...
    public String getTemplateForLanguage(String language) {
        switch (language) {
            ...
            case "Python":
                return getTemplateForPython();
            case "R":
                return getTemplateForR();
            default:
    ...
    private String getTemplateForPython() {
        return "# Python Hello World Program\n\n"
                + "def main():\n"
                + "    print(\"Hello, World!\")\n\n"
    ...
    private String getTemplateForR() {
        return "# R Hello World Program\n\n"
    ...
    public void updateFileFilters(FileChooser fileChooser, String language) {
        ...
        switch (language) {
            ...
            case "R":
                fileChooser.getExtensionFilters().addAll(
                    new FileChooser.ExtensionFilter("R Files", "*.r", "*.R"),
                    new FileChooser.ExtensionFilter("All Files", "*.*")
                );
                break;
            default:
                fileChooser.getExtensionFilters().addAll(
                    new FileChooser.ExtensionFilter("All Source Files", "*.c", "*.cpp", "*.h", "*.hpp", "*.java", "*.py", "*.r", "*.R"),
                    new FileChooser.ExtensionFilter("All Files", "*.*")
                );
        }
    }
